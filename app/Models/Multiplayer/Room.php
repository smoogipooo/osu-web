...
class Room extends Model
{
    ...
    const CATEGORIES = ['normal', 'spotlight', 'featured_artist', 'daily_challenge', 'matchmaking'];
    const TYPE_GROUPS = [
    ...
    const REALTIME_QUEUE_MODES = ['host_only', 'all_players', 'all_players_round_robin', 'matchmaking'];
